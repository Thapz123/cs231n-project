...
class TrainOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--exp_name', type=str, default="Exp5", help='the name of the experiment')
        ...
        self.parser.add_argument('--dataset_name', type=str, default="photoshops_pix2pix", help='name of the dataset')
