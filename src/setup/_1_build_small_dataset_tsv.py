...
ORIGINALS_SMALL_TSV = 'data/originals_small_unprocessed.tsv'
PHOTOSHOPS_SMALL_TSV = 'data/photoshops_small_unprocessed.tsv'
...
def print_dataframes_to_tsv():
    (originals_small, photoshops_small) = build_small_datasets_df()
    originals_small.to_csv(ORIGINALS_SMALL_TSV, sep = '\t', index=False)
    photoshops_small.to_csv(PHOTOSHOPS_SMALL_TSV, sep = '\t', index=False)
    
def build_small_datasets():
    exists_orig = os.path.isfile(ORIGINALS_SMALL_TSV)
    exists_pho = os.path.isfile(PHOTOSHOPS_SMALL_TSV)
